...
VBALL.$instructions.find( '.exit' ).on('click', exitGame );
...
function findLanding() {
    ...
    else if ((power > 0.6 && power <= 0.8) || (power > 0.8 && power <= 0.9 && (currentLane == 1 || currentLane == 5))) {
        laneAniSpeed = 750;
        jumpAniSpeed = 550;
        landingRow = 4;
        jumpYpos = '78px';
    }
    else if ((power > 0.8 && currentLane != 1 && currentLane != 5) || (power > 0.9 && (currentLane == 1 || currentLane == 5))) {
        laneAniSpeed = 500;
        jumpAniSpeed = 500;
        landingRow = 5;
        jumpYpos = '38px';
